...
| Key Name | Type | Description | 
| -------- | ---- | ----------- |
| GlassType | DWORD | The type of glass effect. <br><br><ul><li>0x0=Vista style blur.</li><li>0x1=Aero style blur.</li><ul> |
...
| ColorizationGlassReflectionPolicy | DWORD | Controls where reflections should be rendered. <br><br><ul><li>Titlebar=1<<0</li><li>Aero Peek=1<<2</li><li>Aero Snap=1<<3 (ℹ️ Only valid in Win10)</li></ul> |
...
| Key Name | Type | Description | 
| -------- | ---- | ----------- |
| CaptionButtons | DWORD | Changes caption buttons sizes and the opacity of the button glyphs.<br><br><ul><li>0x0=Windows 10 style (default)</li><li>0x1=Windows Vista style</li><li>0x2=Windows 7 style</li><li>0x3=Windows 8 style</li></ul> |
...
| DisableModernBorders | DWORD | Disable modern rounded window borders. <br><br><ul><li>0x0=Enable modern borders</li><li>0x1=Disable modern borders</li></ul><br>ℹ️ Only valid in Win11 |
